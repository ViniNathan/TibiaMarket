...
class blueDjinnMarket():
    ...
    def priceFinder(self):
        ...
        save_path = "images/itemsPrice/blueDjinn/{0}_price.png".format(self.nome_item)
        cv2.imwrite(save_path, itemPricePhoto)

    def priceImageToText(self):
        price_path = "images/itemsPrice/blueDjinn/{0}_price.png".format(self.nome_item)
